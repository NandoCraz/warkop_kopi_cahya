...
$laba_rugis = queryData('SELECT * FROM laba_rugis');
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php if ($thisPage == 'laba_rugi') echo "active" ?>">
                    ...
                    <form action="" method="post" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" name="tahun" id="tahun" required autocomplete="off">
                            </div>
                            <div class="col-md-4">
                                <label for="bulan">Bulan</label>
                                <select name="bulan" class="custom-select" id="bulan" required>
                        ...
                        <button type="submit" name="submit" class="btn btn-sm btn-success mt-3">Print</button>
                    </form>
