        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="tambah.php" class="btn btn-primary float-start my-4"><i class="fa-solid fa-plus"></i> Tambah List Menu</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION["login"]["role"] == 'admin') : ?>
                                            <a href="edit.php?id=<?= $menu['id']; ?>" class="btn btn-success btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                            <a href="hapus.php?id=<?= $menu['id']; ?>" onclick="return confirm('Yakin Hapus Menu?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                                <?php $no++ ?>
