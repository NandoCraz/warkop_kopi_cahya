...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php if ($thisPage == 'transaksi') echo "active" ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="tambah.php" class="btn btn-primary float-start my-4"><i class="fa-solid fa-plus"></i> Tambah Transaksi</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION["login"]["role"] == 'admin') : ?>
                                            <a href="hapus.php?id=<?= $transaksi['id']; ?>" onclick="return confirm('Yakin Hapus Transaksi?');" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                                <?php $no++ ?>
